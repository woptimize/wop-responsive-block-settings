...
Tested up to:      6.6
Requires PHP:      7.4
Tags:              responsive, visibility, breakpoints
...
= Is the plugin source code publicly available?

Yes, you can find the source code in this [Github repository](https://github.com/woptimize/wop-responsive-block-settings).
