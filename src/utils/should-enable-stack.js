...
* @param {object} previousState - The previous state of the stacking functionality.
...
*/
export default function shouldEnableStack( name, layout, previousState, setAttributes ) {
